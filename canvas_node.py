...
_BIREFNET_MODEL_CATALOG = (
    {
        ...
        "description": "General-purpose foreground segmentation.",
    ...
    },
    {
        ...
        "description": "High-resolution foreground segmentation.",
    ...
    },
    {
        ...
        "description": "Portrait-focused foreground segmentation.",
    ...
    },
    {
        ...
        "description": "Matting-focused foreground segmentation.",
    ...
    },
    {
        ...
        "description": "High-resolution matting-focused segmentation.",
    ...
    },
    {
        ...
        "description": "Dynamic-resolution foreground segmentation.",
    ...
    },
    {
        ...
        "description": "Dynamic-resolution matting-focused segmentation.",
    ...
    },
    {
        ...
        "description": "High-resolution salient-object segmentation.",
    ...
    },
    {
        "id": "cod",
        "label": "BiRefNet — COD",
        "description": "Camouflaged-object segmentation model.",
...
def _get_birefnet_remote_checkpoint_path(model):
    """Return the managed local path for a catalog model, if ComfyUI exposes storage."""
...
def _download_birefnet_checkpoint(model=None):
    ...
    if model is None:
        ...
        download_dir = os.path.join(_get_birefnet_download_dir(), _BIREFNET_REMOTE_DIRECTORY, model["id"])
        os.makedirs(download_dir, exist_ok=True)
...
def _ensure_birefnet_checkpoint(model_path=None):
    ...
    if remote_model:
        checkpoint_path = _get_birefnet_remote_checkpoint_path(remote_model)
...
class BiRefNetMatting:
    ...
    def execute(self, image, model_path, threshold=0.5, refinement=1, mode="remove_background"):
        try:
            ...
            del refinement  # Reserved for future edge refinement controls.
...
async def check_matting_model(request):
    ...
    try:
        ...
        if remote_model:
            local_model_path = _get_birefnet_remote_checkpoint_path(remote_model)
            if local_model_path and _is_native_birefnet_checkpoint(local_model_path):
...
async def matting(request):
    ...
    try:
        ...
        # LayerForge's Draw Mask uses white pixels as the area to remove,
        # while the matting result uses white pixels as the area to keep.
