...
export class CanvasRenderer {
    ...
    actualRender() {
        ...
        if (isDraggingLayers && this.canvas.canvasSelection.selectedLayers.length > 0) {
            this.canvas.canvasLayers.drawLayersDuringDrag(ctx, this.canvas.layers, this.canvas.canvasSelection.selectedLayers, this.canvas.viewport, this.canvas.offscreenCanvas.width, this.canvas.offscreenCanvas.height);
        }
        else {
