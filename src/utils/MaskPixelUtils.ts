 ...
 */
export function applyLuminanceAsAlpha(imageData: ImageData): void {
 ...
 */
export function fillInverseAlphaMask(visibilityData: ImageData, maskData: ImageData): void {
 ...
 */
export function imageDataToBinaryMask(imageData: ImageData, width: number, height: number, channel: 0 | 3): Uint8Array {
 ...
 */
export function calculateDistanceTransform(binaryMask: Uint8Array, width: number, height: number): Float32Array {
